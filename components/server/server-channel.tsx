...
export const ServerChannel = ({
  ...
  return (
    ...
    >
      ...
      {channel.name === "general" && role !== MemberRole.GUEST && (
        <div className="ml-auto flex items-end gap-x-2">
          <ActionTooltip label="Main Channel" side="top">
            <Lock className="block w-4 h-4 text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300 transition" />
          </ActionTooltip>
        </div>
      )}
    </button>
